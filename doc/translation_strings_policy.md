...
This document provides guidelines for internationalization of the FreedomCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `freedomcoin_en.ts` remains unchanged.
