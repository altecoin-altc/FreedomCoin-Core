FreedomCoin Core version v5.1.0 is now available from:  <https://github.com/freedomcoin-project/freedomcoin/releases>
...
- #2170 Better freedomcoin.conf Patriotnode data error notification (furszy)
