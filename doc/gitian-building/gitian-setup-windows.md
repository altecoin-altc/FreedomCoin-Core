...
The build script we'll be using is contained in the FreedomCoin github repository ([contrib/gitian-build.py](https://github.com/freedomcoin-project/freedomcoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the FreedomCoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/FreedomCoin-Project/FreedomCoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, freedomcoin-detached-sigs, and freedomcoin GitHub repos.
