...
This will build freedcoin-qt as well, if the dependencies are met.
 ...
 **For Ubuntu only:** db4.8 packages are available [here](https://launchpad.net/~freedcoin/+archive/freedcoin).
...
If you want to build freedcoin-qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a freedcoin-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip freedcoind" to strip the debug
