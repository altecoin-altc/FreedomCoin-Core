...
To build FreedomCoin Core using AFL instrumentation (this assumes that the
...
with certain assembly code from FreedomCoin Core's code. See [developer notes on sanitizers](https://github.com/FreedomCoin/FreedomCoin/blob/master/doc/developer-notes.md#sanitizers)
