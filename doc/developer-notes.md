...
Run with the `-testnet` option to run with "play FREEDs (tFREED)" on the test network, if you
...
([`valgrind.supp`](https://github.com/freedomcoin/freedomcoin/blob/master/contrib/valgrind.supp))
...
**Sanitizers**
FreedomCoin can be compiled with various "sanitizers" enabled, which add
...
- BitcoinMiner : Generates FREEDs (if wallet is enabled).
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:FreedomCoin/FreedomCoin.git
