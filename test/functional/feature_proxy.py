...
- Create freedomcoinds that connect to them
- Manipulate the freedomcoinds using addnode (onetry) an observe effects
...
class ProxyTest(FreedomCoinTestFramework):
    ...
    def node_test(self, node, proxies, auth, test_onion=True):
        ...
        # Note: freedomcoind's SOCKS5 implementation only sends atyp DOMAINNAME, even if connecting directly to IPv4/IPv6
