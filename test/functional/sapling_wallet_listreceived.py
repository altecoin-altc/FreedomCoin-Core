...
class ListReceivedTest (FreedomCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 FREED.
        ...
        # Send 1 FREED to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 FREED sending them all (fee is 0.1 FREED)
        ...
        # Confirm transaction (2 FREED from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 FREED, send 0.6 FREED + 0.05 FREED fee
