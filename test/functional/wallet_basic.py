...
class WalletTest(FreedomCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 FREED from 1 to 0 using sendtoaddress call.
        ...
        # Node 1 has:
        # - 1 coin of 1.00 FREED
        # - 7 coins of 250.00 FREED
        # - 1 coin of 228.9999xxxx FREED
