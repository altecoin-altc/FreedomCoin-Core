...
# Copyright (c) 2020-2021 The FreedomCoin developers
...
class FullBlockTest(FreedomCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure freedomcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure freedomcoind isn't accepting b28
        ...
        # FreedomCoin: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the freedomcoin code has custom code which does so);
