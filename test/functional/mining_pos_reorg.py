...
class ReorgStakeTest(FreedomCoinTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        # verify that nodes have the expected FREED supply
    ...
    def run_test(self):
        ...
        # Verify that FREED supply was properly updated after the reorgs (including burned fee)
        self.log.info("Check FREED supply...")
