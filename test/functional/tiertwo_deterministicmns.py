...
class DIP3Test(FreedomCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 FREED) to the operator, and (2 * 2.7 FREED) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid FreedomCoin address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid FreedomCoin address InvalidPayee", controller.protx_update_registrar,
