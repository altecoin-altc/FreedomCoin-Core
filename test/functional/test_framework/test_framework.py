...
class FreedomCoinTestFramework():
    ...
    def main(self):
        ...
        parser.add_option("--srcdir", dest="srcdir", default=os.path.normpath(os.path.dirname(os.path.realpath(__file__))+"/../../../src"),
                          help="Source directory containing freedomcoind/freedomcoin-cli (default: %default)")
        ...
        parser.add_option("--usecli", dest="usecli", default=False, action="store_true",
                          help="use freedomcoin-cli instead of RPC for all commands")
    ...
    def _start_logging(self):
        ...
        ch.setLevel(ll)
        # Format logs the same as freedomcoind's debug.log with microprecision (so log files can be concatenated and sorted)
    ...
    def _initialize_chain(self):
        ...
        def copy_cachedir(origin, destination, num_nodes=MAX_NODES):
            for i in range(num_nodes):
                ...
                initialize_datadir(destination, i)  # Overwrite port/rpcport in freedomcoin.conf
        ...
        def clone_cache_from_node_1(cachedir, from_num=4):
            ...
            for i in range(from_num, MAX_NODES):
                ...
                initialize_datadir(cachedir, i)  # Overwrite port/rpcport in freedomcoin.conf
        ...
        def start_nodes_from_dir(ddir, num_nodes=MAX_NODES):
            ...
            for i in range(num_nodes):
                ...
                args = [os.getenv("BITCOIND", "freedomcoind"), "-spendzeroconfchange=1", "-server", "-keypool=1",
        ...
        def generate_pow_cache():
            ...
            # Create cache directories, run freedomcoinds:
    ...
    # FreedomCoin Specific TestFramework
    ...
    """
    Create a ProReg tx, which references an 100 FREED UTXO as collateral.
...
'''
FreedomCoinTestFramework extensions
'''
# !TODO: remove after obsoleting legacy system
class FreedomCoinTier2TestFramework(FreedomCoinTestFramework):
