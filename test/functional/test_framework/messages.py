...
COIN = 100000000 # 1 FREED in satoshis
...
# Objects that map to freedomcoind objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in freedomcoind indicates these should be deserialized as blocks
