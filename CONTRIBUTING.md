...
[Translation Process](https://github.com/freedomcoin/freedomcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the FreedomCoin Core project, and is not to be
confused with overall FreedomCoin Network Protocol consensus changes.
...
Where a patchset proposes to change the FreedomCoin consensus, it must have been
