...
HEADERS += src/activepatriotnode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/freedomcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activepatriotnode.cpp \
           ...
           src/obfuscation.cpp \
           src/freedomcoin-cli.cpp \
           src/freedomcoin-tx.cpp \
           src/freedomcoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/freedomcoin.qrc src/qt/freedomcoin_locale.qrc

TRANSLATIONS += src/qt/locale/freedomcoin_bg.ts \
                src/qt/locale/freedomcoin_de.ts \
                src/qt/locale/freedomcoin_en.ts \
                src/qt/locale/freedomcoin_es.ts \
                src/qt/locale/freedomcoin_fi.ts \
                src/qt/locale/freedomcoin_fr.ts \
                src/qt/locale/freedomcoin_it.ts \
                src/qt/locale/freedomcoin_ja.ts \
                src/qt/locale/freedomcoin_pl.ts \
                src/qt/locale/freedomcoin_pt.ts \
                src/qt/locale/freedomcoin_ru.ts \
                src/qt/locale/freedomcoin_sk.ts \
                src/qt/locale/freedomcoin_sv.ts \
                src/qt/locale/freedomcoin_vi.ts \
                src/qt/locale/freedomcoin_zh_CN.ts \
                src/qt/locale/freedomcoin_zh_TW.ts
