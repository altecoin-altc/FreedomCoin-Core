...
#error Client version information missing: version is not defined by freedomcoin-config.h or in any other way
#endif
...
/**
 * freedomcoind-res.rc includes this file, but it cannot cope with real c++ code.
