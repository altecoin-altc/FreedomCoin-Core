...
// Copyright (c) 2016-2020 The FreedomCoin developers
...
public:
    ...
    /**
     * Amount of freedomcoin coming in to a transaction
...
// FreedomCoin: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
