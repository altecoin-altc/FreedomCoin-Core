...
//
// The Patriotnode Class. It contains the input of the 5000 FREED, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 5000 FREED - checking if valid patriotnode)
