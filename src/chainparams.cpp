...
static Checkpoints::MapCheckpoints mapCheckpoints = {
    ...
    {  1397000, uint256S("862d9d73f5b28a2f0d026fe3206aa063059f46e818e25d5e85bfe7c5fd00d7f9")}
    };
...
public:
    CMainParams()
    {
        ...
        // validation by-pass
        consensus.nFreedomCoinBadBlockTime = 1471401614;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nFreedomCoinBadBlockBits = 0x1c056dac;    // Skip nBit validation of Block 259201 per PR #915
        ...
        vSeeds.emplace_back("seed1.freedomcoin.global", true);
        vSeeds.emplace_back("seed2.freedomcoin.global", true);
        vSeeds.emplace_back("seed3.freedomcoin.global", true);
        ...
        vSeeds.emplace_back("209.181.233.186", true);
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet freedomcoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet freedomcoin script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet freedomcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = {0x3a, 0x80, 0x61, 0xa0};
        // Testnet freedomcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = {0x3a, 0x80, 0x58, 0x37};
        // Testnet freedomcoin BIP44 coin type is '1' (All coin's testnet default)
