...
#ifndef FreedomCoin_WALLET_H
#define FreedomCoin_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_FreedomCoin = 61000, // inherited version..
...
public:
     ...
     * FreedomCoin: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 5000 FREED output and keys which can be used for the Patriotnode
