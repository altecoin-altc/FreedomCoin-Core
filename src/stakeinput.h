...
#ifndef FreedomCoin_STAKEINPUT_H
#define FreedomCoin_STAKEINPUT_H
...
public:
    ...
    bool IsZFREED() const override { return false; }
};


#endif //FreedomCoin_STAKEINPUT_H
