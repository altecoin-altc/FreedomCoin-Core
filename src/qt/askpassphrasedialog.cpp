...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            FreedomCoinGUI* window = static_cast<FreedomCoinGUI*>(parentWidget());
...
{
    FreedomCoinGUI* gui = static_cast<FreedomCoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<FreedomCoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("%1 will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your FREEDs from being stolen by malware infecting your computer.").arg(PACKAGE_NAME) +
            "<br><br><b>" +
