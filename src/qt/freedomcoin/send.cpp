...
#include "qt/freedomcoin/send.h"
#include "qt/freedomcoin/forms/ui_send.h"
#include "qt/freedomcoin/addnewcontactdialog.h"
#include "qt/freedomcoin/qtutils.h"
#include "qt/freedomcoin/sendchangeaddressdialog.h"
#include "qt/freedomcoin/optionbutton.h"
#include "qt/freedomcoin/sendconfirmdialog.h"
#include "qt/freedomcoin/guitransactionsutils.h"
#include "qt/freedomcoin/loadingdialog.h"
...
SendWidget::SendWidget(FreedomCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    coinIcon(new QPushButton())
{
    ...
    ui->btnUri->setSubTitleClassAndText("text-subtitle", tr("Parse a FreedomCoin URI"));
    ...
    // Connect
    connect(ui->pushLeft, &QPushButton::clicked, [this](){onFREEDSelected(true);});
    connect(ui->pushRight,  &QPushButton::clicked, [this](){onFREEDSelected(false);});
...
void SendWidget::showHideCheckBoxDelegations(CAmount delegationBalance)
{
    ...
    // coincontrol is not selected, and we are trying to spend transparent FREEDs.
...
void SendWidget::onShieldCoinsClicked()
{
    ...
    if (availableBalance > 0) {
        ...
        ProcessSend(recipients, true, [this](QList<SendCoinsRecipient>& recipients) {
            ...
            if (!res) {
                inform(tr("Error generating address to shield FREEDs"));
                return false;
            }
        ...
        inform(tr("You don't have any transparent FREEDs to shield."));
    }
}
...
void SendWidget::onFREEDSelected(bool _isTransparent)
{
