...
#include "qt/freedomcoin/forms/ui_patriotnodewizarddialog.h"
    ...
    clientModel(_clientModel)
{
    ...
    ui->labelMessage1a->setText(formatHtmlContent(
                formatParagraph(tr("To create a FreedomCoin Patriotnode you must dedicate %1 (the unit of FreedomCoin) "
