...
#include "qt/freedomcoin/settings/settingswalletrepairwidget.h"
#include "qt/freedomcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/freedomcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(FreedomCoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to FreedomCoinGUI::handleRestart()
