...
#include "qt/freedomcoin/settings/settingssignmessagewidgets.h"
#include "qt/freedomcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(FreedomCoinGUI* _window, QWidget *parent) :
