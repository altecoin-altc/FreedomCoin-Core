...
#include "qt/freedomcoin/settings/settingsconsolewidget.h"
#include "qt/freedomcoin/settings/forms/ui_settingsconsolewidget.h"
...
SettingsConsoleWidget::SettingsConsoleWidget(FreedomCoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(RPCExecutor::CMD_REPLY, (tr("Welcome to the FreedomCoin RPC console.") + "<br>" +
