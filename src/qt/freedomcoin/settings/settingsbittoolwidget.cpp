...
#include "qt/freedomcoin/settings/settingsbittoolwidget.h"
#include "qt/freedomcoin/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(FreedomCoinGUI* _window, QWidget *parent) :
