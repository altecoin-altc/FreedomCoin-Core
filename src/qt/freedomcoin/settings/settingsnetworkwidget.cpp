...
#include "qt/freedomcoin/settings/settingsnetworkwidget.h"
#include "qt/freedomcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/freedomcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(FreedomCoinGUI* _window, QWidget *parent) :
