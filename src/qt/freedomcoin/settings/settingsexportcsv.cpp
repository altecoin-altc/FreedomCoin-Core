...
#include "qt/freedomcoin/settings/settingsexportcsv.h"
#include "qt/freedomcoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(FreedomCoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("FreedomCoin_tx_csv_export(*.csv)") : tr("FreedomCoin_addresses_csv_export(*.csv)"),
                                        nullptr);
