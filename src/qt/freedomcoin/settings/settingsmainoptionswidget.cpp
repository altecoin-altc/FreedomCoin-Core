...
#include "qt/freedomcoin/settings/settingsmainoptionswidget.h"
#include "qt/freedomcoin/settings/forms/ui_settingsmainoptionswidget.h"
#include "QListView"
...
SettingsMainOptionsWidget::SettingsMainOptionsWidget(FreedomCoinGUI* _window, QWidget *parent) :
