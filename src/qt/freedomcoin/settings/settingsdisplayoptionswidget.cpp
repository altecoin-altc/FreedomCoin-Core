...
#include "qt/freedomcoin/settings/settingsdisplayoptionswidget.h"
#include "qt/freedomcoin/settings/forms/ui_settingsdisplayoptionswidget.h"
#include <QListView>
#include <QSettings>
#include <QDir>
#include "guiutil.h"
...
SettingsDisplayOptionsWidget::SettingsDisplayOptionsWidget(FreedomCoinGUI* _window, QWidget *parent) :
