...
#include "qt/freedomcoin/settings/settingsbackupwallet.h"

#include "qt/freedomcoin/settings/forms/ui_settingsbackupwallet.h"
...
SettingsBackupWallet::SettingsBackupWallet(FreedomCoinGUI* _window, QWidget *parent) :
