...
#include "qt/freedomcoin/txviewholder.h"
#include "qt/freedomcoin/tooltipmenu.h"
#include "qt/freedomcoin/sendmultirow.h"
#include "qt/freedomcoin/coldstakingmodel.h"
#include "qt/freedomcoin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(FreedomCoinGUI* parent);
    ~ColdStakingWidget();
