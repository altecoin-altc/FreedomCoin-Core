...
#include "qt/freedomcoin/sendcustomfeedialog.h"
#include "qt/freedomcoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(FreedomCoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &FreedomCoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
