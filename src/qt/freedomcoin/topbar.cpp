...
#include "qt/freedomcoin/forms/ui_topbar.h"
#include "qt/freedomcoin/lockunlock.h"
#include "qt/freedomcoin/qtutils.h"
#include "qt/freedomcoin/receivedialog.h"
#include "qt/freedomcoin/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/freedomcoin/balancebubble.h"
...
TopBar::TopBar(FreedomCoinGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("FreedomCoin")
    updateDisplayUnit();
