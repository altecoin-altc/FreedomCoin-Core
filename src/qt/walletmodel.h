...
#ifndef FreedomCoin_QT_WALLETMODEL_H
#define FreedomCoin_QT_WALLETMODEL_H
...
/** Interface to FreedomCoin wallet from Qt view code. */
...
#endif // FreedomCoin_QT_WALLETMODEL_H
