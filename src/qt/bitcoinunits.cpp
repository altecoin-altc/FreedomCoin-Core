...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(FREED);
    unitlist.append(mFREED);
    unitlist.append(uFREED);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case FREED:
        return QString("freedomcoin");
    case mFREED:
        return QString("mfreedomcoin");
    case uFREED:
        return QString::fromUtf8("ufreedomcoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZFREED)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZFREED);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZFREED)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZFREED));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
